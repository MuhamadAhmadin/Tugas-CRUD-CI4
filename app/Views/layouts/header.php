...
<head>
  ...
  <title>Muhamad Ahmadin | CI Templating</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('') ?>/" class="nav-link <?= (\Config\Services::request()->uri->getSegment(1) == '') ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('') ?>/index2" class="nav-link <?= (\Config\Services::request()->uri->getSegment(1) == 'index2') ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('') ?>/index3" class="nav-link <?= (\Config\Services::request()->uri->getSegment(1) == 'index3') ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
